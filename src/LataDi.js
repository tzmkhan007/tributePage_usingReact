...
class Lata_Mangeshkar extends Component {
    constructor() {
        super();
    }
    ...
    render() {
        ...
        <div className="main_container" >
            <h1 className="text-center" id="head1">Lata Mangeshkar</h1>
            <h3 className="text-center"><em>The Voice of India</em></h3>
            <div className="Di_section">
                <img src="http://media-cdn.list.ly/production/85269/headline?ver=9479159546" className="img-thumbnail img-edit" />
                <p className="main_font">Lata Mangeshkar is an Indian playback singer, and occasional music-composer.</p>
            </div>
            <h4 className="text-center">Here's a time line of Lata Mangeshkar's life:</h4>
            <div className="ul_list">
                            ...
                            <h5>If you have time, you can read more about this incredible human being on this <a href="https://en.wikipedia.org/wiki/Lata_Mangeshkar" className="text-primary" target="_blank">Wikipedia entry</a></h5>
                            </div>
                        </div> 
        </div>
...
export default Lata_Mangeshkar;
